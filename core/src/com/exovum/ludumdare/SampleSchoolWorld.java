...
import com.exovum.ludumdare.components.AnimationComponent;
import com.exovum.ludumdare.components.BodyComponent;
import com.exovum.ludumdare.components.BookComponent;
import com.exovum.ludumdare.components.BookComponent.BookTitle;
import com.exovum.ludumdare.components.BoundsComponent;
import com.exovum.ludumdare.components.ChildComponent;
import com.exovum.ludumdare.components.FontComponent;
import com.exovum.ludumdare.components.SchoolComponent;
import com.exovum.ludumdare.components.StateComponent;
import com.exovum.ludumdare.components.TextureComponent;
import com.exovum.ludumdare.components.TransformComponent;
import com.exovum.ludumdare.systems.RenderingSystem;

import java.util.Random;

import static com.exovum.ludumdare.components.BookComponent.BookTitle.getBookTitleByID;

/**
 * Created by exovu_000 on 12/9/2016.
 */

public class SampleSchoolWorld extends GameWorld {


    // PS: Use an abstract World class next time that supplies the base info
    // connecting SampleSchoolWorld and GameWorld together for simplification
    ...
    public SampleSchoolWorld(PooledEngine engine, World world) {
        super(engine, world);
        this.engine = engine;
