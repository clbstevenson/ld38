 ...
 */
public class SampleSchoolInput extends InputAdapter {

    private final OrthographicCamera camera;

    private Vector3 touch;

    private SampleSchoolWorld world;

    public SampleSchoolInput(OrthographicCamera camera, SampleSchoolWorld world) {
        this.camera = camera;
        this.world = world;
        touch = new Vector3();
    }
